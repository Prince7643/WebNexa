import { ArrowRight, Code2, Globe, LayoutDashboard, Loader2Icon, Sparkles, Wand2, Zap } from 'lucide-react';
...
const features = [
    {
        ...
        desc: 'Generate complete modern websites from a single prompt in seconds.'
    },
    {
        icon: <Globe className='size-6' />,
        title: 'Responsive Design',
        desc: 'Every website automatically adapts beautifully across all devices.'
    },
    {
        icon: <Zap className='size-6' />,
        title: 'Lightning Fast',
        desc: 'Optimized performance and instant deployment with zero setup.'
    },
    {
        icon: <Code2 className='size-6' />,
        title: 'Clean Code Export',
        desc: 'Get production-ready React + Tailwind code for your projects.'
    },
    {
        icon: <LayoutDashboard className='size-6' />,
        title: 'Visual Editing',
        desc: 'Customize layouts, colors, fonts, and sections visually.'
    },
    {
        icon: <Sparkles className='size-6' />,
        title: 'Modern Components',
        desc: 'Beautiful UI blocks crafted for startups and SaaS products.'
    }
]
const Home = () => {
    ...
    return (
        <>
            ...
            <header id='Home' className=' text-white flex flex-col items-center pb-10'>
                ...
                <div className="rainbow relative z-0 bg-white/15 overflow-hidden p-px flex items-center justify-center rounded-full transition duration-300 active:scale-100 mt-28 md:mt-32">
                    <button className="flex items-center justify-center gap-3 pl-4 pr-6 py-3 text-white rounded-full font-medium bg-gray-900/80 backdrop-blur">
                        ...
                        <span className='text-xs'>Designed A Modern Websites</span>
                    </button>
                </div>
                ...
                <p className="text-sm md:text-base text-gray-300 bg-clip-text text-center max-w-lg mt-4.5 px-4">
                    A flexible hero section designed to work across startups, Saas products, portfolios and landing pages.
                </p>
                    <form onSubmit={onSubmitHandler} className='bg-white/10 max-w-2xl w-full rounded-xl p-4 mt-10 border border-indigo-600/70 focus-within:ring-2 ring-indigo-500 transition-all'>
                        <textarea onChange={e=>setInput(e.target.value)} name="" id="" className='bg-transparent outline-none text-gray-300 resize-none w-full' rows={4} placeholder='Discribe your presentation in details ' required></textarea>
                        <button className="ml-auto flex items-center gap-2 bg-gradient-to-r from-[#CB52D4] to-indigo-500 rounded-md px-4 py-2">
                            {!loading?
                            "Create Your Website":
            ...
            <section
                ...
                >
                    <div className='text-center'>
                        ...
                        <p className='text-gray-400 max-w-2xl mx-auto mt-5'>
                            Powerful AI tools designed to help you create and launch websites faster than ever.
                        </p>
                    </div>
                    ...
                    <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-20'>
                        {features.map((feature, index) => (
                            <div
                                key={index}
                                className='group p-8 rounded-3xl border border-indigo-500/40 bg-[#171719] hover:bg-white/[0.07] transition-all'
                            >
                                <div className='size-14 rounded-2xl bg-gradient-to-br from-indigo-500/20 to-purple-500/20 flex items-center justify-center text-indigo-300 border border-white/10'>
                                    {feature.icon}
                                </div>
                ...
                >
                    <div className='grid lg:grid-cols-2 gap-20 items-center'>
                        <div>
                            ...
                            <h2 className='text-4xl md:text-5xl font-semibold mt-4 leading-tight text-white'>
                                Create websites in 3 simple steps
                            </h2>

                            <div className='space-y-8 mt-12'>
                                {[
                                    'Describe your website idea with AI prompts',
                                    'Generate layouts, sections and designs instantly',
                                    'Customize and publish your website online'
                                ].map((item, index) => (
                                    <div
                                        key={index}
                                        className='flex gap-5'
                                    >
                                        <div className='size-12 rounded-2xl bg-indigo-500/20 text-indigo-400 flex items-center justify-center font-semibold'>
                                            0{index + 1}
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <p className='text-gray-400 mt-2'>
                                                Fast, simple and built for creators, developers and startups.
                                            </p>
                                        </div>
                                    </div>
                                ))}
                            ...
                            <div className='space-y-5'>
                                <div className='bg-[#111827] rounded-2xl p-5 border border-white/10'>
                                    ...
                                    <p className='mt-3 text-white'>
                                        “Create a modern AI SaaS landing page with pricing and testimonials.”
                                    </p>
                                </div>

                                <ArrowRight className='mx-auto text-indigo-400' />

                                <div className='bg-gradient-to-br from-indigo-500/20 to-purple-500/20 rounded-2xl p-8 border border-white/10'>
                                    <div className='grid grid-cols-2 gap-4'>
                                        <div className='h-28  rounded-xl bg-white/10'></div>
                ...
                >
                    <div className='relative overflow-hidden rounded-[40px] border border-white/10 bg-gradient-to-br from-indigo-600/20 to-purple-600/20 p-12 md:p-20 text-center'>
                        ...
                        <div className='relative z-10'>
                            ...
                            <h2 className='text-4xl md:text-6xl font-semibold mt-5 leading-tight text-white'>
                            ...
                            <p className='text-gray-300 max-w-2xl mx-auto mt-6'>
                                Join thousands of creators and startups building websites faster with AI.
                            </p>

                            <div  className='mt-10'>
                                <a href='#Home' className=' bg-white text-black px-8 py-4 rounded-2xl font-semibold hover:scale-105 transition-all'>
                                Start For Free
                            </a>
                            </div>
                        </div>
             ...
             <footer className='border-t border-white/10 mt-20'>
                    <div className='max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-4 gap-10'>
                        ...
                        <div>
                            <div className='flex items-center gap-3'>
                                <div className='size-10 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center font-bold'>
                                    W
                                </div>
                            ...
                            <p className='text-gray-400 mt-5 text-sm leading-relaxed'>
                                AI powered website builder for startups, creators and developers.
                            </p>
                        </div>
                    ...
                    <div className='border-t border-white/10 py-6 text-center text-sm text-gray-500'>
                        © 2026 WebNexa. All rights reserved.
                    </div>
                </footer>
        </>
    )
